...
from training_functions import synthetic_supervised_train, single_self_supervised_train, generate_problem, generate_problem_videos
...
data_generator = lambda ranks, shape, alpha, kappa: generate_problem_videos(ranks, shape, alpha, kappa, device)
